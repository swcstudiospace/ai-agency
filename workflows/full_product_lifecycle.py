...
full_product_lifecycle_workflow = Workflow(
    ...
    description=(
        ...
        "Warp Oz is the bottom execution layer for multi-step shell/coding."
    ),
    steps=[
        Step(
            name="Research Score Price",
            team=research_team,
            description=with_warp_guidance("Discover niches, rank SKUs, unit economics."),
        ),
        Step(
            name="Supply Chain Setup",
            team=supply_chain_team,
            description=with_warp_guidance("Locate suppliers, outreach drafts, shipping pipeline."),
        ),
        Step(
            name="Brand Creative Listing",
            team=creative_team,
            description=with_warp_guidance("Brand, PromptWise/Fal UGC, listing drafts."),
        ),
        Step(
            name="Store Build Compliance",
            team=store_ops_team,
            description=with_warp_guidance("Shopify drafts, policies, headless storefront notes."),
        ),
        Step(
            name="Marketing Launch",
            team=growth_team,
            description=with_warp_guidance("Ad drafts only; HITL spend vault before launch."),
        ),
        Step(
            name="Retention Setup",
            team=retention_team,
            description=with_warp_guidance("CRM/post-purchase macros and loops."),
        ),
    ],
)

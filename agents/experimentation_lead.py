"""experimentation_lead agent — thin wiring; brain lives in prompts/experimentation_lead/."""

from agents._factory import build_agent
from agents.profiles import profile_by_key

_p = profile_by_key("experimentation_lead")

experimentation_lead = build_agent(
    name=_p.name,
    role=_p.role,
    persona=_p.key,

"""partnerships_manager agent — thin wiring; brain lives in prompts/partnerships_manager/."""

from agents._factory import build_agent
from agents.profiles import profile_by_key

_p = profile_by_key("partnerships_manager")

partnerships_manager = build_agent(
    name=_p.name,
    role=_p.role,
    persona=_p.key,

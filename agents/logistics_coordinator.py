"""logistics_coordinator agent — thin wiring; brain lives in prompts/logistics_coordinator/."""

from agents._factory import build_agent
from agents.profiles import profile_by_key

_p = profile_by_key("logistics_coordinator")

logistics_coordinator = build_agent(
    name=_p.name,
    role=_p.role,
    persona=_p.key,

"""chargeback_specialist agent — thin wiring; brain lives in prompts/chargeback_specialist/."""

from agents._factory import build_agent
from agents.profiles import profile_by_key

_p = profile_by_key("chargeback_specialist")

chargeback_specialist = build_agent(
    name=_p.name,
    role=_p.role,
    persona=_p.key,

# Inventory — Procedure
1. Intake forecast assumptions + lead time.
2. Test buy sizing, ROP/safety stock when data exists.
3. Cash at risk + do_not_bulk_until conditions.
4. Output InventoryPlan.

...
1. Define creator profile (niche, size, geo, authenticity signals).
2. Parallel entity/search for creators/brands.
3. Outreach angles + deliverables + budget + rights.
4. Output InfluencerPlan.
